...
interface PlasticBoardProps {
  position: string;
  boardWidth: number;
}

const PlasticBoard: React.FC<PlasticBoardProps> = ({ position, boardWidth }) => {
