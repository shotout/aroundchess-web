...
const sidebarLinks = [
  ...
  { 
    ...
    icon: BarChart2,
    children: [
      { name: "My Training Plan", href: "/dashboard/analysis/training-plan", icon: Brain },
      { name: "My Game History", href: "/dashboard/analysis/game-history", icon: History },
      { name: "My Progress", href: "/dashboard/analysis/my-progress", icon: TrendingUp },
      { name: "My Reports", href: "/dashboard/analysis/my-reports", icon: FileBarChart },
      { name: "Import Games", href: "/dashboard/analysis/import-games", icon: Upload },
    ]
  },
  { 
    name: "Learning",
    icon: BookOpen,
    children: [
      { name: "Opening Theory", href: "/dashboard/learning/openings", icon: Swords },
      { name: "Middlegame Strategy", href: "/dashboard/learning/middlegame", icon: Target },
      { name: "Endgame Mastery", href: "/dashboard/learning/endgame", icon: Crown },
    ]
  },
  { 
    name: "Practice",
    ...
    children: [
      ...
      { name: "Board Vision", href: "/dashboard/practice/board-vision", icon: Grid },
      { name: "Endgame Training", href: "/dashboard/practice/endgame", icon: Crown },
    ]
  }
]
...
export function Sidebar({ open, setOpen }: SidebarProps) {
  ...
  const currentPage = sidebarLinks.reduce<SidebarItem | null>((found, section) => {
          ...
          <ScrollArea className="flex-1 py-3">
            <nav className="space-y-1 px-3">
              {sidebarLinks.map((section, index) => {
                ...
                const isActive = section.children?.some(child => pathname === child.href)
