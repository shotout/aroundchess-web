                ...
                {isSubmitted ? (
                  <div className="flex flex-col items-center py-6">
                    ...
                    <p className="text-gray-600 text-center mb-6">
                      Your PGN was successfully uploaded. You can now analyze
                      your Game with our Advanced Chess Engine!
                    </p>
                  ...
                  <>
                    <p className="text-sm text-center max-w-2xl mx-auto text-gray-700 mb-6">
                      ...
                      <span className="font-medium">PGN</span> directly or
                      upload a <span className="font-medium">PGN</span> file.
                    </p>
