...
export default function Timeframe({ onDateChange, disabled = false }: TimeframeProps) {
    ...
    return (
        <>
            <button
                ...
                type="button"
                disabled={disabled}
                className={`flex w-full items-center gap-[6px] text-[#717375] border border-[#D8DCE0] bg-[#F8F9FC] rounded-[8px] px-[12px] h-[42px] md:h-[32px] text-[16px] md:text-[14px] ${disabled ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
            >
