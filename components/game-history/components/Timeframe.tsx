...
export default function Timeframe() {
    ...
    return (
        <>
            <button onClick={() => setOpen(true)} type="button" className="flex w-full items-center gap-[6px] text-[#717375] border border-[#D8DCE0] bg-[#F8F9FC] rounded-[8px] px-[12px] h-[32px] text-[14px]">
