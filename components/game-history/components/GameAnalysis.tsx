...
export default function GameAnalysis({
    ...
    return (
        ...
        >
            <div onClick={(e) => e.stopPropagation()} data-tutorial="4" className="relative flex md:block flex-col justify-between w-full lg:w-[400px] xxl:w-[450px] 2xl:w-[520px] h-[100dvh] top-[-20px] md:top-0 md:h-[580px] xxl:h-[678px] 2xl:h-[724px] overflow-x-hidden bg-gradient-to-b from-white to-[#D0EFFF] rounded-0 lg:rounded-[16px] p-[16px] lg:py-[10px] xxl:p-[20px]">
