...
export const queenendgames: BaseEndgameTopic = {
  id: "queen-endgames",
  title: "Queen Endgames",
  description: "Master the essential concepts and techniques for queen endgames",
  ...
  resources: [
    {
      ...
      description: "Learn the essential concepts of queen endgames",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/queen-endgames"
    },
    {
      title: "Advanced Queen Endgames",
      description: "Master complex queen endgames positions",
      platform: "lichess.org",
      url: "https://lichess.org/study/queen-endgames"
    }
  ],
  relatedTopics: [
    "endgame-principles",
