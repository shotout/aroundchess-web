...
export const drawingtechniques: BaseEndgameTopic = {
  id: "drawing-techniques",
  title: "Drawing Techniques",
  description: "Master the essential concepts and techniques for drawing techniques",
  ...
  resources: [
    {
      title: "Drawing Techniques Fundamentals",
      description: "Learn the essential concepts of drawing techniques",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/drawing-techniques"
    },
    {
      title: "Advanced Drawing Techniques",
      description: "Master complex drawing techniques positions",
      platform: "lichess.org",
      url: "https://lichess.org/study/drawing-techniques"
    }
  ],
  relatedTopics: [
    "endgame-principles",
