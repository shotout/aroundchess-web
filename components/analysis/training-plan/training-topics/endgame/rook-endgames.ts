...
export const rookendgames: BaseEndgameTopic = {
  id: "rook-endgames",
  title: "Rook Endgames",
  description: "Master the essential concepts and techniques for rook endgames",
  ...
  resources: [
    {
      ...
      description: "Learn the essential concepts of rook endgames",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/rook-endgames"
    },
    {
      title: "Advanced Rook Endgames",
      description: "Master complex rook endgames positions",
      platform: "lichess.org",
      url: "https://lichess.org/study/rook-endgames"
    }
  ],
  relatedTopics: [
    "endgame-principles",
