...
export const pawnendgames: BaseEndgameTopic = {
  id: "pawn-endgames",
  title: "Pawn Endgames",
  description: "Master the essential concepts and techniques for pawn endgames",
  ...
  resources: [
    {
      title: "Pawn Endgames Fundamentals",
      description: "Learn the essential concepts of pawn endgames",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/pawn-endgames"
    },
    {
      title: "Advanced Pawn Endgames",
      description: "Master complex pawn endgames positions",
