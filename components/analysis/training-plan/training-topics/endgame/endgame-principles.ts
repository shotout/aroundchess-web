...
export const endgameprinciples: BaseEndgameTopic = {
  id: "endgame-principles",
  title: "Endgame Principles",
  description: "Master the essential concepts and techniques for endgame principles",
  ...
  resources: [
    {
      title: "Endgame Principles Fundamentals",
      description: "Learn the essential concepts of endgame principles",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/endgame-principles"
    },
    {
      title: "Advanced Endgame Principles",
      description: "Master complex endgame principles positions",
      platform: "lichess.org",
      url: "https://lichess.org/study/endgame-principles"
    }
  ],
  relatedTopics: [
    "endgame-principles",
