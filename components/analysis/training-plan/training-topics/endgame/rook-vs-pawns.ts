...
export const rookvspawns: BaseEndgameTopic = {
  id: "rook-vs-pawns",
  title: "Rook Vs Pawns",
  description: "Master the essential concepts and techniques for rook vs pawns",
  ...
  resources: [
    {
      title: "Rook Vs Pawns Fundamentals",
      description: "Learn the essential concepts of rook vs pawns",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/rook-vs-pawns"
    },
    {
      title: "Advanced Rook Vs Pawns",
      description: "Master complex rook vs pawns positions",
      platform: "lichess.org",
      url: "https://lichess.org/study/rook-vs-pawns"
    }
  ],
  relatedTopics: [
    "endgame-principles",
