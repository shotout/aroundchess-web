...
export const bishopknightmate: BaseEndgameTopic = {
  id: "bishop-knight-mate",
  title: "Bishop Knight Mate",
  description: "Master the essential concepts and techniques for bishop knight mate",
  ...
  resources: [
    {
      title: "Bishop Knight Mate Fundamentals",
      description: "Learn the essential concepts of bishop knight mate",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/bishop-knight-mate"
    },
    {
      title: "Advanced Bishop Knight Mate",
      description: "Master complex bishop knight mate positions",
      platform: "lichess.org",
      url: "https://lichess.org/study/bishop-knight-mate"
    }
  ],
  relatedTopics: [
    "endgame-principles",
