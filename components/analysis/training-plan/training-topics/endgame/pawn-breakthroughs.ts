...
export const pawnbreakthroughs: BaseEndgameTopic = {
  id: "pawn-breakthroughs",
  title: "Pawn Breakthroughs",
  description: "Master the essential concepts and techniques for pawn breakthroughs",
  ...
  resources: [
    {
      title: "Pawn Breakthroughs Fundamentals",
      description: "Learn the essential concepts of pawn breakthroughs",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/pawn-breakthroughs"
    },
    {
      title: "Advanced Pawn Breakthroughs",
      description: "Master complex pawn breakthroughs positions",
      platform: "lichess.org",
      url: "https://lichess.org/study/pawn-breakthroughs"
    }
  ],
  relatedTopics: [
    "endgame-principles",
