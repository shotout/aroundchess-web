...
export const endgamestudies: BaseEndgameTopic = {
  id: "endgame-studies",
  title: "Endgame Studies",
  description: "Master the essential concepts and techniques for endgame studies",
  ...
  resources: [
    {
      title: "Endgame Studies Fundamentals",
      description: "Learn the essential concepts of endgame studies",
      platform: "chess.com",
      url: "https://www.chess.com/lessons/endgame-studies"
    },
    {
      title: "Advanced Endgame Studies",
      description: "Master complex endgame studies positions",
      platform: "lichess.org",
      url: "https://lichess.org/study/endgame-studies"
    }
  ],
  relatedTopics: [
    "endgame-principles",
