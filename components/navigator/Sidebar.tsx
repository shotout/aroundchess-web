        ...
        {isSignedIn && (
          ...
          >
            ...
            <div className="xl:hidden flex justify-center gap-[14px] mt-[12px]">
              <Link href="/privacy-policy" className="text-[3vw] text-[#000] underline">
                Privacy Policy
              </Link>

              <Link href="/terms-of-service" className="text-[3vw] text-[#000] underline">
                Terms of Service
              </Link>

              <Link href="/eu-compliance" className="text-[3vw] text-[#000] underline">
                EU Compliance
              </Link>
            </div>
          </motion.div>
