...
import { DifficultyFilter } from "./lib/middlegame";

interface MiddlegameFiltersProps {
...
const MiddlegameFilters: React.FC<MiddlegameFiltersProps> = ({
  localSearchTerm,
  handleSearchChange,
  difficultyFilter,
...
export default MiddlegameFilters;
