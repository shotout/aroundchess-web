            ...
            <div className="w-full flex flex-wrap items-center justify-center gap-[16px]">
              <div className="flex flex-col justify-center gap-[12px] w-full md:w-[490px] bg-[rgba(255,255,255,.65)] backdrop-blur-[8px] border-[2px] border-[#FAFDFF] rounded-[16px] px-[12px] py-[16px] md:py-[24px]">
                <div className="flex items-center gap-[12px]">
                  <Image
                    src="/images/play-practice/puzzle-icon.svg"
                    alt="Puzzles"
                    width={80}
                    height={48}
                  />
                  <div className="w-full">
                    ...
                    <p className="text-[14px] leading-[120%] md:min-h-[40px]">
                      Train with more than 500,000 Puzzles.
                    </p>
                  </div>
                </div>
                <Link href="/playground/puzzle" className={btnClass}>
                  Start <FaArrowRight />
                </Link>
              </div>
              ...
              <div className="flex flex-col justify-center gap-[12px] w-full md:w-[490px] bg-[rgba(255,255,255,.65)] backdrop-blur-[8px] border-[2px] border-[#FAFDFF] rounded-[16px] px-[12px] py-[16px] md:py-[24px]">
                <div className="flex items-center gap-[12px]">
                  <Image
                    src="/images/play-practice/board-visions-icon.svg"
                    alt="Board Vision"
                    width={80}
                    height={48}
                  />
                  <div className="w-full">
                    ...
                    <p className="text-[14px] leading-[120%] md:min-h-[40px]">
                      Answer technical Chess Questions from positions of your previous Games to improve your Board Vision.
                    </p>
                  </div>
                </div>
                <Link href="/playground/board-vision" className={btnClass}>
                  Start <FaArrowRight />
                </Link>
              </div>
              ...
              <div className="flex flex-col justify-center gap-[12px] w-full md:w-[490px] bg-[rgba(255,255,255,.65)] backdrop-blur-[8px] border-[2px] border-[#FAFDFF] rounded-[16px] px-[12px] py-[16px] md:py-[24px]">
                <div className="flex items-center gap-[12px]">
                  <Image
                    src="/images/play-practice/endgame-training-icon.svg"
                    alt="Endgame Training"
                    width={80}
                    height={48}
                  />
                  <div className="w-full">
                    ...
                    <p className="text-[14px] leading-[120%] md:min-h-[40px]">
                      Practice a variety of Endgame Positions and quickly improve your Endgame Skills!
                    </p>
                  </div>
                </div>
                <Link href="/playground/endgame-training" className={btnClass}>
                  Start <FaArrowRight />
                </Link>
              </div>
            </div>
