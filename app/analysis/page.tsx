    ...
    <Navigation>
      <div className="flex flex-1 flex-col overflow-y-auto">
        ...
        >
          ...
          {/* <div className="flex w-full justify-center my-2 xl:hidden">
          ...
          <div className="hidden xl:flex flex-row w-6/6 items-center justify-between gap-2">
            <div className="hidden xl:block w-4/6 text-xs sm:text-sm md:text-md lg:text-lg">
              AI-powered chess analysis provides deep insights into positional
              and tactical aspects of a game. It evaluates piece coordination,
              pawn structure, king safety, and overall positional advantages,
              helping players understand strategic strengths and weaknesses
            </div>
