            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Aroundchess maintains approximately 1,000 average monthly
                  active recipients within the EU. This number is an average
                  calculated based on the preceding 6-month period. This figure
                  is updated on a regular basis (quarterly/semi-annually).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  transparently, reflecting any significant changes to the
                  active user base or relevant compliance practices.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  For further questions or requests regarding compliance with
                  the Digital Services Act, please contact our compliance team
                  directly at{" "}
                  <a
                    href="mailto:contact@aroundchess.com"
                    className="text-blue-600 hover:text-blue-800 underline font-medium"
          ...
          <section className="mb-10">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <p className="text-gray-700 leading-relaxed mb-4">
                For any compliance-related inquiries or questions regarding our
                EU compliance measures, please contact us at{" "}
                <a
                  href="mailto:contact@aroundchess.com"
                  className="text-blue-600 hover:text-blue-800 underline font-medium"
                >
