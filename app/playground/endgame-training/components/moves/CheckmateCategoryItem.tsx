...
export const CheckmateCategoryItem: React.FC<CheckmateCategoryItemProps> = ({
  ...
  return (
    <div onClick={() => onCategorySelect(movesToCheckmate)} className="rounded-xl p-[6px] xl:p-4 border border-gray-200 bg-white flex items-center hover:shadow-md transition-all max-h-[64px] md:max-h-40 2xl:min-w-[343px]">
