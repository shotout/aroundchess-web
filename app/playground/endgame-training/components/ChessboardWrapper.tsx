...
export default function ChessboardWrapper({
  ...
  const onSquareClick = useCallback(
    (square: Square) => {
      // Only allow interaction if it's white's turn and game is ongoing
      ...
      if (!moveTo) {
        ...
        setPosition(game.fen()); // This will trigger the StockfishEngine to make black's move
  ...
  const onDrop = useCallback(
    (sourceSquare: string, targetSquare: string) => {
      // Only allow white moves when it's white's turn and game is ongoing
      ...
      try {
        ...
        // Update game state after successful move
        setMoveHistory(game.history({ verbose: true }));
        setPosition(game.fen()); // This triggers StockfishEngine to make black's move
