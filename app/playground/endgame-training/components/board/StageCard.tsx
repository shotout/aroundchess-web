  ...
  return (
    <div
      ...
      className={`
        ...
        relative border-2 rounded-lg p-3 space-x-5 cursor-pointer hover:border-blue-base transition-all h-24 flex items-center justify-center overflow-hidden
    ...
    >
      ...
      <div
        className={`text-[65px] font-bold bg-gradient-to-b from-[#017BFF] from-[5%] to-[#5DDEFF] inline-block text-transparent bg-clip-text relative z-10`}
      >
        {stageNumber}
      </div>
    </div>
