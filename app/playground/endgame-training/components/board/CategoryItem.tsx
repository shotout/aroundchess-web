...
export const CategoryItem: React.FC<CategoryItemProps> = ({
  ...
  return (
    <div className="rounded-md overflow-hidden p-4 xl:p-5 border border-gray-200 bg-[#F9FAFC] flex max-w-auto hover:bg-blue-base/10 transition-all md:max-h-[226px] md:h-52">
