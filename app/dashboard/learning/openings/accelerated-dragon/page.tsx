            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Reset to initial position (after 1.e4 c5 2.Nc3 g6)</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="variations" className="space-y-4">
                  {acceleratedDragon.variations.map((variation, index) => (
                    <Card
                      key={index}
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        {variation.keyIdeas.map((idea, ideaIndex) => (
                          <div
                            key={ideaIndex}
                            className="text-[14px] --sm flex items-center gap-2"
                          >
                ...
                <TabsContent value="resources" className="space-y-4">
                  {acceleratedDragon.resources.map((resource, index) => (
