...
export default function EndgamePage() {
  ...
  const getEndgamePosition = (topicId: string) => {
    return endgamePositions[topicId] || "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"
  }
    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex justify-between items-center">
        <div className="space-y-1">
          <h2 className="text-2xl font-bold tracking-tight">Endgame Mastery</h2>
          <p className="text-muted-foreground">
            Perfect your endgame technique with comprehensive lessons and exercises
          </p>
        </div>
      </div>
          ...
          <Card key={topic.id} className="p-6 hover:shadow-lg transition-shadow">
            <div className="flex justify-center mb-4">
              <div style={{ width: '100%', maxWidth: '280px', aspectRatio: '1/1' }}>
                <Chessboard
                  position={getEndgamePosition(topic.id)}
                  boardSize={280}
                  isDraggable={false}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Link href={`/dashboard/learning/endgame/${topic.id}`}>
